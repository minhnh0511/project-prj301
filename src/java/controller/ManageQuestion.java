 ...
 * @author admin
 */
@WebServlet(name = "ManageQuestion", urlPatterns = {"/question"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (role.equals("1")) {
            if (service.equals("viewQuestion")) {
                ...
                ResultSet rs = dao.getData("select q.* \n"
                ...
                try {
                    while(rs.next()) {
                        ...
                        String Choice3 = rs.getString(5);
                        String Choice4 = rs.getString(6);
                        int QuestionKey = rs.getInt(7);
